...
/* ------------------------------ Macro Start ---------------------------- */
	/* *** APB high-speed (APB2) *** */
#define RCC_SYSCLK_APB1_None				RCC_CFGRAPB2_PPRE2_NONE
#define RCC_SYSCLK_APB1_DIV_2				RCC_CFGRAPB2_PPRE2_2
#define RCC_SYSCLK_APB1_DIV_4				RCC_CFGRAPB2_PPRE2_4
#define RCC_SYSCLK_APB1_DIV_8				RCC_CFGRAPB2_PPRE2_8
#define RCC_SYSCLK_APB1_DIV_16				RCC_CFGRAPB2_PPRE2_16

	/* *** APB low-speed (APB1) *** */
#define RCC_SYSCLK_APB2_None				RCC_CFGRAPB2_PPRE1_NONE
#define RCC_SYSCLK_APB2_DIV_2				RCC_CFGRAPB2_PPRE1_2
#define RCC_SYSCLK_APB2_DIV_4				RCC_CFGRAPB2_PPRE1_4
#define RCC_SYSCLK_APB2_DIV_8				RCC_CFGRAPB2_PPRE1_8
#define RCC_SYSCLK_APB2_DIV_16				RCC_CFGRAPB2_PPRE1_16
